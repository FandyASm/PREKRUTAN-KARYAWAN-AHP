...
function getAlternatifPV($id_alternatif, $id_kriteria) {
    ...
    $query = "SELECT nilai FROM pv_alternatif WHERE id_alternatif = ? AND id_kriteria = ?";
    $stmt = mysqli_prepare($koneksi, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "ii", $id_alternatif, $id_kriteria);
    ...
    return isset($pv) ? $pv : null; // Nilai default jika tidak ada hasil
}
